...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh   , R, {int64_t ans = S64(src1) * S64(src2); R(rd) = ans >> 32; printf("%d * %d = %lld\n", src1, src2, (long long)ans); });
  /* INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu , R, R(rd) = (word_t)((int64_t)src1 * src2 >> 32)); */
  /* INSTPAT("0000001 ????? ????? 011 ????? 01100 11", mulhu  , R, R(rd) = (word_t)((int64_t)src1 * src2 >> 32)); */
