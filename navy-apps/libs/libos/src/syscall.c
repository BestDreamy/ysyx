...
intptr_t _syscall_(intptr_t type, intptr_t a0, intptr_t a1, intptr_t a2) {
  register intptr_t _gpr1 asm (GPR1) = type; // system call id
  register intptr_t _gpr2 asm (GPR2) = a0;   // parameters in a0~a2
  register intptr_t _gpr3 asm (GPR3) = a1;
  register intptr_t _gpr4 asm (GPR4) = a2;
  register intptr_t ret asm (GPRx);          // ret value in a0 
  // ecall 
